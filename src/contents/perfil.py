...
- Ok, bacana, mas as razões pela qual pessoas usam código vão além das 
necessidades do mercado de trabalho, e acreditem, isso é o de menos. 

- E ninguém menos do que este velhinho para resumir bem por quais motivos programação faz bem.
                       
![image](https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQVn3lYxT_R_r7h2jXi7m1na14ieHxFoxBM5rErWE5fxGVHltZs)                        
                       
- Este é Fred Brooks (1931-2022), antes dele, um programa que rodava em um 
computador, não rodava em outro diferente. Seu trabalho na IBM resolveu isso. 
Em 1975, ele resumiu bem como pessoas encontram significado quando estão programando:

> _Por que programar é divertido? Que delícias seu praticante pode esperar como recompensa?_
>
>                       
> _O primeiro é a pura alegria de fazer coisas. Assim como a criança se delicia com sua torta de lama, o adulto gosta de construir coisas de sua própria autoria._
>                       
> _Em segundo lugar está o prazer de fazer coisas que sejam úteis para outras pessoas. No fundo, queremos que outros usem nosso trabalho e o considerem útil._
>
> _O terceiro é o fascínio de criar objetos complexos, semelhantes a quebra-cabeças, com peças móveis interligadas e observá-los funcionar em ciclos sutis, representando as consequências dos princípios construídos desde o início._
>
